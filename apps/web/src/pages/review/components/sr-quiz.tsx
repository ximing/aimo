...
const SRQuizContent = () => {
  ...
  return (
    <div className="space-y-4">
      ...
      {/* Card */}
      <div className="bg-white dark:bg-dark-800 rounded-xl shadow-sm border border-gray-200 dark:border-dark-700 p-6 overflow-hidden">
        <h3 className="text-xl font-semibold text-gray-900 dark:text-gray-50 mb-3">
          {currentCard?.memo.title}
        </h3>

        <div className="rounded-lg bg-gray-50 dark:bg-dark-700/50 p-4 max-h-[52vh] overflow-y-auto">
          <p className="text-gray-700 dark:text-gray-300 whitespace-pre-wrap break-words leading-7">
